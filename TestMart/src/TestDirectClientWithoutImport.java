...
//		URL url = new URL("http://localhost:8080/TestMart/TestMartCatalogService?wsdl");
		URL url = new URL("http://localhost:8888/productCatalogB?wsdl");
		// 1st argument service URI, refer to wsdl document above
		// 2nd argument is service name, refer to wsdl document above
//		QName qname = new QName("http://www.oracle.com","TestMartCatalogService");
		QName qname = new QName("http://www.oracle.com","TestMartCatalog");
