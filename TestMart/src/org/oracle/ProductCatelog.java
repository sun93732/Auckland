...
@WebService(endpointInterface="org.oracle.ProductCatalogInterface", portName="TestMartCatalogPort", 
serviceName="TestMartCatalogService",targetNamespace="http://www.oracle.com")
public class ProductCatelog implements ProductCatalogInterface {
  ...
  /*  @Override
    ...
    /* (non-Javadoc)
	 * @see org.oracle.ProductCatalogInterface#getProductCategories(java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.oracle.ProductCatalogInterface#addProductCategories(java.lang.String, java.lang.String)
	 */
    @Override
