 ...
 * 
 */
@WebServiceClient(name = "AddNumbersService", targetNamespace = "http://duke.example.org", wsdlLocation = "http://localhost:8080/jaxws-async/addnumbers?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jaxws-async/addnumbers?wsdl");
